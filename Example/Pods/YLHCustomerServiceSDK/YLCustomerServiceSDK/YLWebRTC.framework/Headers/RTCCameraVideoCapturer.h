...
@protocol RTCCaptureSessionDelegate <NSObject>

#if TARGET_OS_IPHONE
- (Boolean)rtcCaptureOrientationManual;
- (UIDeviceOrientation)rtcCaptureManualOrientation;
#endif
...
@property (nonatomic, strong)   id<RTCCaptureSessionDelegate> captureSessionDelegate;
